...
func (self *VacationDaysLeft) Get(c echo.Context) error {
	...
	embeddedRel, _ := hal.NewResourceRelation("vacationDaysLefts")
...
func (self *VacationDaysLeft) FindById(c echo.Context) error{
	repository := VacationDaysLeftRepository()
...
func (self *VacationDaysLeft) Persist(c echo.Context) error{
	repository := VacationDaysLeftRepository()
...
func (self *VacationDaysLeft) Put(c echo.Context) error{
	repository := VacationDaysLeftRepository()
	id, _ := strconv.Atoi(c.Param("id"))
	params := make(map[string]string)
...
func (self *VacationDaysLeft) Remove(c echo.Context) error{
	repository := VacationDaysLeftRepository()
	id, _ := strconv.Atoi(c.Param("id"))
	self, err := repository.FindById(id)
	if err != nil {
