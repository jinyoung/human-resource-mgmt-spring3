...
func (self *Vacation) Get(c echo.Context) error {
	...
	embeddedRel, _ := hal.NewResourceRelation("vacations")
...
func (self *Vacation) FindById(c echo.Context) error{
	repository := VacationRepository()
...
func (self *Vacation) Persist(c echo.Context) error{
	repository := VacationRepository()
...
func (self *Vacation) Put(c echo.Context) error{
	repository := VacationRepository()
	id, _ := strconv.Atoi(c.Param("id"))
	params := make(map[string]string)
...
func (self *Vacation) Remove(c echo.Context) error{
	repository := VacationRepository()
	id, _ := strconv.Atoi(c.Param("id"))
	self, err := repository.FindById(id)
	if err != nil {
